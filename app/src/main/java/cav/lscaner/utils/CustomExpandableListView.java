...
//http://dajver.blogspot.ru/2015/01/draggble-listview-android.html
...
public class CustomExpandableListView extends ExpandableListView {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        if(ev.getAction()==MotionEvent.ACTION_DOWN){
            ...
            Object item = getAdapter().getItem(dragPosition); // пробуем получить гроуп и итем
            ...
            //магия
            View dragger = itemView.findViewById(R.id.expant_list_item_bt);
